    ...
    <div class="insert">
        @foreach ($users as $user)
            <div class="card" style="width: 18rem; display:inline-block; margin: 10px;">
                <img class="foto rounded-circle mx-auto d-block" src="{{ asset('profile_images/'.$user->photo) }}" alt="..." style="width:260" height="260">
                <div class="card-body">
                    ...
                    <div class="modal-body">
                        <form method="POST " id="formEdit" action="{{ route('users.update', $user->id) }}" class="user"
                            ...
                            <div class="form-group text-center">
                                <label for="profileImage" class="form-label"><b>Seleccionar foto de perfil</b></label>
                                <input type="file" id="profileImage" name="profile_image" class="form-control"
                                    accept="image/*" onchange="previewImage(event)">

                                <img id="imagePreview" src="{{ asset('storage/profile_images/' . $user->profile_image) }}"
                                    alt="Vista previa" class="mt-3 img-thumbnail"
