...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="fondo text-black/50  dark:text-white/50">
        <img class="absolute -left-20 top-0 max-w-[877px] imagenDifuminada " src="{{ asset('img/backgoundd.svg') }}"
            alt="...">
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <nav class="-mx-3 flex flex-1 justify-end">
                            @auth
                                ...
                                <a href="{{ url('/dashboard') }}"
                                    ...
                                    <b class="colorLetraMorada"> Dashboard </b>
                                </a>
                            @else
                                <a href="{{ route('login') }}"
                                    class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                                    <b class="colorLetraMorada"> Iniciar sesión </b>
                                </a>
                                ...
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}"
                                        class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                                        <b class="colorLetraMorada"> Registrar usuario </b>
                                    </a>
                                @endif
                            @endauth
                        </nav>
                ...
                <main class="presentacion row justify-content-center">
                    <div class="presentacion__contenido  ">
                        <h1 class="presentacion__contenido__titulo"> Intencionada<strong
                                class="titulo-destaque">Mente</strong>
                        </h1>
                        <p class="presentacion__contenido__texto "> Armoniza
                                     tu entorno, intenciona tus pensamientos y
                ...
                {{-- <main class="mt-12">
                    <div class="w-screen min-h-screen grid gap-6 lg:grid-cols-2 lg:gap-8 px-4">

                        


                    <div class=" w-full grid gap-6 lg:grid-cols-2 lg:gap-8"> 
