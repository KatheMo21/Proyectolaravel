        ...
        <style>
            ...
            * {
            ...
            .inicioSesion {
                ...
                font-family: "Montserrat", sans-serif;
                color: #9582b9;
                text-shadow: 3px 3px 6px rgba(116, 49, 53, 0.3);
                font-size: 24px;
...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="fondo text-black/50  dark:text-white/50">
        <img class="absolute -left-20 top-0 max-w-[877px] imagenDifuminada tamañoNebulosa"
            src="{{ asset('img/backgoundd.svg') }}" alt="...">
                        ...
                        <nav class="-mx-3 flex flex-1 justify-end">
                            @auth
                                ...
                                <a href="{{ url('/dashboard') }}"
                                    ...
                                    <b class="inicioSesion"> Dashboard </b>
                                </a>
                            @else
                                <a href="{{ route('login') }}"
                                    class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                                    <b class=" inicioSesion "> Iniciar sesión </b>
                                </a>
                                ...
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}"
                                        class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
                                        <b class="registrar"> Registrar usuario </b>
                                    </a>
                                @endif
                            @endauth
                        </nav>
